...
begin
  foreach t in array array[
    'profiles','events','event_teamleaders','event_office','event_photographers','event_layers','layer_templates','event_vehicles','vehicle_passengers','team_broadcasts','tracks','spots',
